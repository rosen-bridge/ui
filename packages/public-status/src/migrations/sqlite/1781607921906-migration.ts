...
export class Migration1781607921906 implements MigrationInterface {
  name = 'Migration1781607921906';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "temporary_aggregated_status_entity" (
                ...
                PRIMARY KEY ("eventId", "triggerTxId")
            )
        `);
    await queryRunner.query(`
    ...
    await queryRunner.query(`
            CREATE TABLE "temporary_guard_status_entity" (
                ...
                PRIMARY KEY ("eventId", "guardPk", "triggerTxId")
            )
        `);
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            DROP INDEX "IDX_d03acd864c3ccc4274562bbebd"
        `);
    await queryRunner.query(`
            DROP INDEX "IDX_4382413985dc677f801c6ed29b"
        `);
    await queryRunner.query(`
            DROP INDEX "IDX_ea5b8b459baaccb7c72523cb52"
        `);

...
export type EmptyStateProps = OverridableType<EmptyStateBaseProps, EmptyStateOverrides, never>;

export const EmptyState = (props: EmptyStateProps) => {
  const { subtitle, ...rest } = useConfig('EmptyState', props);
  ...
  return (
    <div {...rest}>
      ...
      {subtitle && (
        <div className="RosenEmptyState-subtitle">Adjust your filter and try again.</div>
      )}
    </div>
  );
};

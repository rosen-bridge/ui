...
const createFieldSchema = (field: FilterFieldConfig): z.ZodType<FilterField> => {
  ...
  switch (field.type) {
    ...
    case 'stringArray':
      return z.object({ 
        key: z.literal(field.key),
        type: z.literal(field.type),
        operator: z.enum(field.operators || FILTER_FIELD_STRING_ARRAY_OPERATORS, operatorParams),

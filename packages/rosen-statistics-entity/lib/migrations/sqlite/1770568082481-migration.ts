  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            ALTER TABLE "watcher_count_entity"
                RENAME TO "temporary_watcher_count_entity"
        `);
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            INSERT INTO "watcher_count_entity"("id", "network", "count")
            SELECT "id",
                "network",
                "count"
            FROM "temporary_watcher_count_entity"
        `);
    await queryRunner.query(`
            DROP TABLE "temporary_watcher_count_entity"
        `);
    await queryRunner.query(`
            ALTER TABLE "watcher_count_entity"
                RENAME TO "temporary_watcher_count_entity"

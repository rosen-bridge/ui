...
export class Migration1775987532007 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            ALTER TABLE "bridged_amount_entity" DROP COLUMN "toChain"
        `);
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            ALTER TABLE "bridged_amount_entity" DROP CONSTRAINT "UQ_58ac9b1052d94a3a68b1630cd1b"
        `);
    await queryRunner.query(`
            ALTER TABLE "bridged_amount_entity" DROP COLUMN "lastProcessedHeight"
        `);
    await queryRunner.query(`
            ALTER TABLE "bridged_amount_entity"

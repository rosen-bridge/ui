...
export class Migration1769857283334 implements MigrationInterface {
  name = 'Migration1769857283334';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            ALTER TABLE "bridge_fee_entity"
                RENAME COLUMN "toChain" TO "lastProcessedHeight"
        `);
    await queryRunner.query(`
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            ALTER TABLE "bridge_fee_entity"
            ADD "lastProcessedHeight" character varying NOT NULL
        `);
    await queryRunner.query(`
            ALTER TABLE "bridge_fee_entity"
                RENAME COLUMN "lastProcessedHeight" TO "toChain"
        `);
  }
}

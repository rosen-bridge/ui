...
const WithdrawalText = () => {
  return (
    <>
      ...
      <Typography as="div" style={{ marginTop: '8px' }}>
        ...
        <ul>
          <li>
            <strong>Do not</strong> send all three WIDs—you must keep one here for your Watcher to
            function correctly.
          </li>
          <li>
            <strong>Moving all WIDs</strong> transfers your permits, rewards, and collateral to the
            new address.
          </li>
        </ul>
        To unlock permits, move one WID back here, unlock, and then immediately send it back to your
        secure wallet. This keeps your assets protected.
      </Typography>
    </>
  );
};
